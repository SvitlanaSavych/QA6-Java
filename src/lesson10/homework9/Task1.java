...
// а склад сім’ї може з часом змінюватися. До проходження теми “Колекції” всі домашні завдання
// повинні бути виконані з використанням масивів (НЕ використовуйте інтерфейси List, Set, Map,
// поки про це не буде прямо сказано у завданні).
//
//                      Завдання
...
//  які не розходяться і можуть народжувати/усиновлювати своїх дітей. Діти можуть дорослішати та йти
//  з сім'ї, створюючи свою власну.
...
//          • відгукнутися (respond) (метод виводить на екран повідомлення Привіт, хазяїн.
//            Я - [ім'я тварини]. Я скучив!)
//          • зробити домашню гидоту (foul) (метод виводить на екран повідомлення:
//            "Потрібно добре замести сліди...")

//   • Опишіть у класі Human такі поля:
//           • Ім'я (name)
//           • Прізвище (surname)
...
//    • Опишіть у класі Human та реалізуйте такі методи:
...
//             Oписи хитрості повинна залежати від рівня хитрості вихованця, якщо понад 50 -[дуже хитрий],
//             якщо менше або дорівнює 50 -[майже не хитрий])

//    • Пере визначте метод toString() в обох класів;
//          • Клас Pet повинен виводити повідомлення наступного виду: dog{nickname='Rock', age=5,
//            trickLevel=75, habits=[eat, drink, sleep]}, де dog - вид тварини;
//          • Клас Human повинен виводити повідомлення наступного виду: Human{name='Michael',
//            surname='Karleone', year=1977, iq=90, mother=Jane Karleone, father=Vito Karleone,
...
//    • Оголосіть усі поля наявних класів як приватні. Додайте гетери та сетери; зробіть рефакторинг
//      наявних методів з урахуванням змін.
...
//        • Видаліть з Human всю інформацію, що дублюється в класі Family (Human повинен зберігати тільки
//          інформацію, що описує себе)
...
//          Human{name='Name', surname='Surname', year=1, iq=1}.
...
//  • Вирішіть, які поля варто використовувати для порівняння в методі equals() (наприклад, звички
//    тварини можуть змінюватися).
...
//    (у дитини на батьків та вихованця), щоб вийшла повноцінна сім’я. Викличте всі доступні методи у
//    дитини (включаючи метод toString()) та у його вихованця.
